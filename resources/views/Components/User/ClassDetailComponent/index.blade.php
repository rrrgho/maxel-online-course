                            ...
                            <div class="mt-4">
                                @if ($data->your_class === 'REJECTED')
                                    <small class="text-secondary"><i>You have booked this class, but your payment is
                                            <span class="text-danger"><b>{{ $data->your_class }}</b></span></i></small>
                                    <br>
                                    <a href="" class="btn btn-block w-100 mt-2 text-white btn-danger">RECONFIRM
                                        PAYMENT</a>
                                @else
                                    <small class="text-secondary"><i>You have booked this class, your booking status is
                                            <span class="text-warning"><b>{{ $data->your_class }}</b></span></i></small>
                                    <br>
                                @endif
                            </div>
                        @else
